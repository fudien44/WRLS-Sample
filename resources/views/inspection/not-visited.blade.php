...
<div class="div-content">
    ...
    <div class="table-card">
        ...
        <table id="not-visited" class="cell-border stripe" style="width: 100%">
            <thead>
                <tr>
                    <th></th>
...
<script>
    ...
    let table = new DataTable("#not-visited", {
        ajax: {
            url: "/pending",
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    if (
                        ...
                        var newCurrentDate = new Date(formattedDate);
                        ...
                        return (
                            ...
                            ' id="remaining-days' +
                            $id +
                            '" style="background-color:green;color:white;width:100%;padding:2px">Days until inspection: ' +
                            remainingDays +
                            "</div>"
                        );
                    } else if (
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.message.cert_pot) {
                        ...
                        $(".attach-body").append(
                            `<a href='{{url('${attachment}')}}' target="_blank" class='btn-view-watClear btn btn-primary'>Certificate of potability</a>`
                        );
                    }
