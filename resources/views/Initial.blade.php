...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Initial Application</h1>
</div>
<div class="accordion" id="accordionExample">
    <div class="card ">
      ...
      <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
        <div class="card-body">
          ...
          <br><br>
          1. Certificate of Potability (Laboratory Results of Water Sample)<br>
          2. Sanitary survey of water source<br>
          3. Drinking water site clearance<br>
          4. Engineer's Report<br>
          5. Plans and specifications for the complete multi-stage water purification design of the plant prepared, signed and sealed by a privately practicing licensed Sanitary Engineer.
        
        </div>
        <div class="text-center">

            <a href="/initial-wrs" class="btn btn-success btn-icon-split mb-3">
    ...
    {{-- <div class="card">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
        ...
        <div class="text-center">
            <a href="/operational" class="btn btn-success btn-icon-split mb-3">
